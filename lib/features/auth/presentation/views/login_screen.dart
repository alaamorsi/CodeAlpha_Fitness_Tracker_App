        ...
        listener: (context, state) {
          ...
          if (state is AuthenticationLoginSuccessState) {
            CacheHelper.saveData(key: 'uId', value: state.uId)
                .then((value) async {
              uId = state.uId;
              await authenticationCubit.getUserData();
              if(context.mounted) {
                      ...
                      BuildButton(
                        onPressed: (){
                          if(formKey.currentState!.validate())
                            {
                              authenticationCubit.userLogin(email: emailController.text, password: passwordController.text);
                            }
                        },
                          isLoading: state is AuthenticationLoginLoadingState,
